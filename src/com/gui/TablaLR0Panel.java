...
public class TablaLR0Panel extends JPanel {
    ...
    private void onOpen(ActionEvent e) {
        ...
        if (ch.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                String content = com.coleccionCanonica.Grammar.readWholeFile(selectedFile.getAbsolutePath());
    ...
    private void onBuild(ActionEvent e) {
        ...
        try {
            ...
            ResultadosTablaLR0Frame frame = new ResultadosTablaLR0Frame(r);
